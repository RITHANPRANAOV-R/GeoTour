  ...
  Future<void> saveProfile() async {
    if (nameController.text.isEmpty || 
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please fill in essential fields: Name, Badge, Station, and Phone")),
      );
      return;
    }
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildField("Badge / Batch Number *", badgeController, Icons.badge_outlined),
                    _buildField("Rank / Designation", rankController, Icons.military_tech_outlined),
                    _buildField("Personal Phone Number *", phoneController, Icons.phone_outlined, keyboardType: TextInputType.phone),
                    ...
                    _buildField("Police Station Name *", stationController, Icons.location_city_outlined),
                    _buildField("Division / District", divisionController, Icons.map_outlined),
                    _buildField("Station Landline", stationPhoneController, Icons.local_phone_outlined, keyboardType: TextInputType.phone),
                    _buildField("Station Full Address", stationAddressController, Icons.location_on_outlined, maxLines: 2),
